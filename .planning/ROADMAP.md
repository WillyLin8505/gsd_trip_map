...
- [x] 03-01-PLAN.md — Installs + shadcn init + 11 components + font restore + QueryProvider/ThemeProvider + buildCityBias fix + day-colors/types + RED test scaffolds
...
- [x] 03-03-PLAN.md — Rich PlaceRow with opening hours/price via details fetch + hoursUnknown badge + UnscheduledAlert + ProgressSteps (DISP-02)
...
- [x] 06-02-PLAN.md — Slice F2 (EDIT-02): per-day 「自動安排」 end-to-end (classifyPlace + scheduleSingleDay reorder=true meal-slotting + DayCard button + onAutoArrange wiring)
...
| 6. Interactive Single-Day Editing | 2/2 | Complete   | 2026-06-26 |
